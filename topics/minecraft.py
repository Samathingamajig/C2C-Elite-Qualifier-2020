...
def minecraft(chatbot: Chatbot):
  ...
  if not like_minecraft:
    ...
    own_game = chatbot.require_boolean("Do you own any copy of Minecraft?")
    if own_game:
      year_gotten = chatbot.require_number("What year did you buy (or get gifted) Minecraft (for the first time)?")
      ...
      chatbot.require_from_list("What console (PC/Mobile/XBox/PlayStation/Wii U/Windows 10) did you first own Minecraft for?", "PC", "Mobile", "XBox", "PlayStation", "Wii U", "Windows 10")
